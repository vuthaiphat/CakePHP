...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Day', true), array('action' => 'edit', $day['Day']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Day', true), array('action' => 'delete', $day['Day']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $day['Day']['id'])); ?> </li>
